...
foreach ($dbCities as $city) {
    // Với mỗi thành phố, khởi tạo mảng quận rỗng
    $locations[$city['name']] = [];

    // 2. Lấy quận/huyện thuộc thành phố này
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                ...
                <div class="alert alert-info shadow-sm sticky-top mt-3" style="top: 90px;">
                    ...
                    <p class="mb-2">
                        Bạn đang ở chế độ <b>Xem</b>.
                        Vui lòng <a href="login.php" class="fw-bold text-primary">Đăng nhập Admin</a>
                        để thêm hoặc chỉnh sửa địa điểm.
                    </p>

                    <hr class="my-2">

                    <p class="mb-0 text-warning fw-semibold">
                        🔔 Lưu ý: Vui lòng lọc xong mới quay random nếu dùng!
                    </p>
                </div>
